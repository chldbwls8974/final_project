...
<div class="businessman-search">
	<div class="businessman-search-navigation" style="margin-top: 50px; text-align: center;">
		<p style="font-size: 35px; font-weight: bolder; margin:0 auto; padding: 20px 0 10px 0;">사업자 권한 조회</p>
	</div>
	<!-- 사업자권한 조회 -->
	<br>
			   ...
			   <c:forEach items="${list}" var="bu">
					<li>
						<div class="tbody-box">
							...
							<div id="tbody-list"><a href="<c:url value='/board/detail?bo_num=${ma.bo_num}'/>">${bu.bo_title}</a></div>
