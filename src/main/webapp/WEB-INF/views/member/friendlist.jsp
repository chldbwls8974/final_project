...
<style type="text/css">
	...
	.top-btn{width: 130px; height: 40px; margin: auto auto 10px; border: none;
	...
	<div class="member-search">
		<div>
			...
			<div class="member-table-div">
				<ul id="membertable">
					<c:forEach items="${memberListByMark}" var="member">
...
<script type="text/javascript">
	...
	function getSearchList(){
		...
		ajaxJsonToJson2(false, "post", "/member/searchfilterByFriend", data, (a)=>{
			console.log(a)
				if(a.res){
					$('#membertable').empty();
					str=``;
