...
<style type="text/css">
	.container{ 
		height: 100%; padding: 70px 0 70px 0;
	}
	.title{ 
		width:20%; font-size: 35px; font-weight: bolder; text-align: center; letter-spacing: -3px;
	...
	.btn{
		border-radius: 3px; width: 300px; height: 45px; border: none; 
